...
export default function RentalCard() {
  return (
    <div>
        <Navbar/>
        <h1 className='text-4xl flex justify-center text-white mt-10'>"Lend or Rent: Choose Your Car Adventure"</h1>
...
<div class="max-w-sm bg-gray-700 border cursor-pointer hover:opacity-90 border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="p-5">
        <Link to=''>
            <h5 class="mb-2 text-2xl  w-96 font-bold tracking-tight text-cyan-500 dark:text-white">Rent a Vehicle</h5>
        </Link>
